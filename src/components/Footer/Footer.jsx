...
import { NavLink as MainNavlink } from "react-router-dom";
          ...
          <div className="flex flex-wrap -mx-4">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="w-full mb-10">
                <MainNavlink href="/#" className="mb-1 flex flex-row gap-1 items-center text-white max-w-[160px] ">
                  <img
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="w-full mb-10">
                ...
                <div className="flex items-center mb-6">
                  <a href="#" className="flex items-center justify-center w-8 h-8 mr-3 border rounded-full border-stroke text-dark hover:border-primary hover:bg-primary hover:text-white dark:border-dark-3 dark:text-white dark:hover:border-primary sm:mr-4 lg:mr-3 xl:mr-4">
